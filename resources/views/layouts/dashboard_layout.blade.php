...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Mini - Sevice Record Management System" />
        <meta name="author" content="Joseph Andrey Dacera" />
        <title>Mini - SRMS</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Mini - SRMS</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="#!"><i class="fas fa-file-alt"></i>&nbsp;&nbsp;Activity Log</a></li>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <div class="align-items-center text-center">
                                <img src="{{ url('/src/logo.png') }}" alt="" class="dashboard-logo">
                            </div>
                            <hr>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="">Leave of Absence</a>
                                    <a class="nav-link" href="">Travel Order</a>
                                </nav>
                            </div>
                        </div>
                    </div>
